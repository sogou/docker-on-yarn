 ...
 * the {@link DockerApplicationMaster_23} is launched. </p>
 * 
 * <p> The {@link ContainerLaunchContext} in this scenario defines the resources to be allocated for the 
 * {@link DockerApplicationMaster_23}'s container, the local resources (jars, configuration files) to be made available 
 * and the environment to be set for the {@link DockerApplicationMaster_23} and the commands to be executed to run the 
 * {@link DockerApplicationMaster_23}. <p>
 * 
...
public class DockerClient {
 ...
 // private String shellCommand = ""; 
  ...
  public static final String SCRIPT_PATH = "common.sh";
